...
import { Image, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, useColorScheme as useDeviceColorScheme } from 'react-native';
  ...
  return (
    <View style={{ flex: 1, backgroundColor: themeColors.background }}>
      <View style={styles.header}>
        <Text style={[styles.headerText, { color: themeColors.tint }]}>{t('profile')}</Text>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('name')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
              value={name}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('age')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
              value={age}
              onChangeText={setAge}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('address')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
              value={address}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('phone')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
              value={phone}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('emergencyContact')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: themeColors.text }]}>{t('emergencyPhone')}</Text>
            <TextInput
              style={[styles.input, { color: themeColors.text, backgroundColor: themeColors.background, borderColor: colorScheme === 'dark' ? '#333' : '#eee' }]}
