...
const ICONS: any = {
  ...
  "SEXUAL HARASSMENT": (
    <FontAwesome5 name="user-shield" size={80} color="#000" />
  ),
  "WILD ANIMAL": (
    <MaterialCommunityIcons name="dog-side" size={80} color="#000" />
  ),
...
export default function EmergencyDetail() {
  ...
  const handleNotify = async () => {
    try {
      ...
      const res = await fetch("https://mutech.quddus.my/api/send-family", {
        method: "POST",
        body: JSON.stringify({
          id: currentUser.id,
